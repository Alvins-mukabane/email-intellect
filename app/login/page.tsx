    ...
    <div className="pt-32 pb-24 px-6 min-h-screen flex items-center justify-center bg-slate-50">
      <div className="bg-white p-10 rounded-3xl shadow-xl border border-slate-100 max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-extrabold text-slate-800 mb-2">Welcome back</h1>
          <p className="text-slate-500 font-medium">Sign in to access your intelligent agent.</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm font-medium text-slate-500">
          Don't have an account? <Link href="/signup" className="text-blue-600 hover:text-blue-800 font-bold">Sign up here</Link>
        </div>
