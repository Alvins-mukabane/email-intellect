      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-24 relative z-10">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-8 lg:gap-12">
          {steps.map((s, i) => (
            <div
              key={i}
              className="bg-white rounded-xl sm:rounded-[2rem] p-3 sm:p-12 text-center shadow-lg hover:shadow-xl transition-shadow border border-slate-100 flex flex-col items-center group"
            >
              ...
              <h3 className="font-bold text-slate-800 text-[3vw] sm:text-2xl mb-1 sm:mb-4 tracking-tight">
                {s.title}
              </h3>
