...
export function Hero() {
  return (
    <div className="relative pt-40 pb-56 lg:pb-72 lg:pt-56 overflow-hidden bg-gradient-to-br from-[#1E3A8A] via-[#2563EB] to-[#60A5FA]">
      ...
      <div className="absolute bottom-[-2px] left-0 w-full overflow-hidden leading-none z-10">
        <svg className="relative block w-[calc(100%+1.3px)] h-[120px] sm:h-[180px] md:h-[240px]" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-24 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          <div className="text-white relative z-20">
            <h1 className="text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-tight tracking-tight mb-6">
              Supercharge Your<br/>Inbox with AI
            </h1>
            <p className="text-lg lg:text-xl text-blue-100 mb-10 max-w-[480px] font-medium leading-relaxed">
              Let AI manage your emails. Get summaries, task lists, and key opportunities instantly.
            </p>
            <button className="bg-blue-700 hover:bg-blue-800 text-white font-bold text-lg px-8 py-4 rounded-xl shadow-[0_8px_30px_rgb(29,78,216,0.3)] transition-all hover:-translate-y-1">
              Connect Your Gmail
            </button>
            
            <div className="mt-16">
              <p className="text-sm font-semibold text-blue-200/80 mb-4 tracking-wider uppercase">Trusted by professionals worldwide</p>
