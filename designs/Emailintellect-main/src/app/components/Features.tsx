    ...
    <div className="pb-12 sm:pb-24 pt-6 sm:pt-12 bg-slate-50 relative -mt-16 sm:-mt-40 z-30">
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-24">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-8">
          {features.map((f, i) => (
            <div key={i} className="bg-white rounded-xl sm:rounded-2xl p-3 sm:p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100/50">
              <div className="flex flex-col sm:flex-row items-center sm:items-center gap-2 sm:gap-5 mb-2 sm:mb-5">
                ...
                <h3 className="font-bold text-gray-900 text-[3vw] sm:text-lg leading-snug text-center sm:text-left">{f.title}</h3>
              </div>
